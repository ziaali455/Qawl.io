...
class MyLoginView extends StatefulWidget {
  ...
  @override
  State<MyLoginView> createState() => _LoginViewState();
}

class _LoginViewState extends State<MyLoginView> {
  ...
  List<Widget> _buildHeader(BuildContext context) {
    ...
    TextStyle? hintStyle;
    late Color registerTextColor = Colors.green;

    if (isCupertino) {
      final theme = CupertinoTheme.of(context);
      registerTextColor = Colors.green;
  ...
  @override
  void didUpdateWidget(covariant MyLoginView oldWidget) {
